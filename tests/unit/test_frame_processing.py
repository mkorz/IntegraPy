...
def test_set_bits_positions():
    from IntegraPy import set_bits_positions
...
def test_bytes_with_bits_set():
    from IntegraPy import bytes_with_bits_set
    assert bytes_with_bits_set(set([3, 14, 128]), 128, 1) == \
        b'\x04 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80'


def test_format_user_code():
    from IntegraPy import format_user_code
...
def test_checksum():
    from IntegraPy import checksum
...
def test_prepare_frame():
    from IntegraPy import prepare_frame
...
def test_parse_event():
    from IntegraPy import parse_event
